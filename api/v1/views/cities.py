...
# Route to retrieve all City objects of a specific State
...
# Route to retrieve a specific City object by ID
...
# Route to delete a specific City object by ID
...
# Route to create a new City object under a specific State
...
# Route to update an existing City object by ID
