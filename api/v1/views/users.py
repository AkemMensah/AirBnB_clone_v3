...
# Route to retrieve all User objects
...
# Route to retrieve a specific User object by ID
...
# Route to delete a specific User object by ID
...
# Route to update an existing User object by ID
