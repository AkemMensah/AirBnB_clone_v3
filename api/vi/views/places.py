...
# Route to retrieve all Place objects of a City
...
# Route to retrieve a specific Place object by ID
...
# Route to delete a specific Place object by ID
...
# Route to update an existing Place object by ID
