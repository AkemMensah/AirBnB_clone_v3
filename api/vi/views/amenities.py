...
# Route to retrieve a specific Amenity object by ID
...
# Route to delete a specific Amenity object by ID
...
# Route to update an existing Amenity object by ID
...
def bad_request(error):
    '''Return Bad Request message from illegal requests to the API.'''
